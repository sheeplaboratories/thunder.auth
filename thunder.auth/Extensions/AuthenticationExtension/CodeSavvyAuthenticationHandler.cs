...
{
    public class CodeSavvyAuthenticationHandler : OAuthHandler<CodeSavvyAuthenticationOptions>
    {
        public CodeSavvyAuthenticationHandler(
            IOptionsMonitor<CodeSavvyAuthenticationOptions> options,
        ...
        protected override async Task<AuthenticationTicket> CreateTicketAsync(ClaimsIdentity identity, AuthenticationProperties properties, OAuthTokenResponse tokens) {
            ...
            payload.Add(CodeSavvyClaimTypes.CodeSavvyToken, tokens.AccessToken);
